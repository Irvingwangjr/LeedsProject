...
from Models.Modules.FusionModule import LambdaGateFusion


class LambdaGateNet(BaseModel):
    ...
    def loadFusionModule(self):
        return LambdaGateFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
