...
from Models.Modules.FusionModule import LambdaGateFusionV2


class LambdaGateNetV2(BaseModel):
    ...
    def loadFusionModule(self):
        return LambdaGateFusionV2(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
