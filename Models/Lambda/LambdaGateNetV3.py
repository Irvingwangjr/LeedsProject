...
from Models.Modules.FusionModule import LambdaGateFusionV3


# match换成DNN
class LambdaGateNetV3(BaseModel):
    ...
    def loadFusionModule(self):
        ...
        return LambdaGateFusionV3(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim, 3,
                                  fieldWeight=self.fieldWeight)
    ...
    def loadMatchingModule(self):
        HyperParam.AutoIntWithFieldMatchMlpDims[0] = HyperParam.AutoIntFeatureNum * 5 * HyperParam.AutoIntFeatureDim
        return AllConcatMlpWithWeightLinear(HyperParam.AutoIntWithFieldMatchMlpDims, HyperParam.AutoIntFeatureNum,
                                     self.tempEmbed, fieldWeight=self.fieldWeight)
