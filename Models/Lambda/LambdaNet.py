...
from Models.Modules.FusionModule import MultiLayerTransformer, LambdaNetFusion


class LambdaNet(BaseModel):
    ...
    def loadFusionModule(self):
        return LambdaNetFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
