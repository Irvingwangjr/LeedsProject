...
from Models.Modules.FusionModule import LambdaGateFusionV3, LambdaGateFusionV4, LambdaGateFusionV5


# match换成DNN
#实验发现，深度在3/4层效果不错，Head提升没有收益
class LambdaGateNetV5(BaseModel):
    ...
    def loadFusionModule(self):
        ...
        return LambdaGateFusionV5(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim,
