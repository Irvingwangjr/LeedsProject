...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearLTEFusion
import torch


class FiBiNetLTE(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearLTEFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
