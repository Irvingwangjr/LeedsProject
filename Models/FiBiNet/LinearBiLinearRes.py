...
from Models.Modules.FusionModule import XDeepFMFusion, XDeepFMFusionV2, LinearBiLinearFusion, LinearBiLinearFusionV2, \
    LinearBiLinearFusionV3, LinearBiLinearResFusion
import torch
import copy


class LinearBiLinearRes(BaseModel):
    ...
    def loadFusionModule(self):
        ...
        return LinearBiLinearResFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim,
