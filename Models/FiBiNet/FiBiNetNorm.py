...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearNormFusion
import torch


class FiBiNetNorm(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearNormFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
