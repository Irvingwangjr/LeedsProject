...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearBNFusion
import torch


class FiBiNetBN(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearBNFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
