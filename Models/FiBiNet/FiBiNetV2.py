...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearDotFusion
import torch


class FiBiNetV2(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearDotFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
    ...
    def loadMatchingModule(self):
        HyperParam.AutoIntMatchMlpDims[0] = int((HyperParam.AutoIntFeatureNum * (
                HyperParam.AutoIntFeatureNum - 1) / 2))
