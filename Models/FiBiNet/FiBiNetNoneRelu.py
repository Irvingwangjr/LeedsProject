...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearNoneReluFusion
import torch


class FiBiNetNoneRelu(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearNoneReluFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
