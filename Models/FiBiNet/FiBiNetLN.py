...
from Models.Modules.FusionModule import SeNetBiLinearFusion, SeNetBiLinearBNFusion, SeNetBiLinearLNFusion
import torch


class FiBiNetLN(BaseModel):
    ...
    def loadFusionModule(self):
        return SeNetBiLinearLNFusion(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim)
