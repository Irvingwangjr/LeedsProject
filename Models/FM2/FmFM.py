...
from Models.Modules.MatchModule import AllConcatMlpV2, FmMatchModule
from Models.Modules.FusionModule import FmFMFusionModule
...
class FmFM(BaseModel):
    ...
    def loadFusionModule(self):
        return FmFMFusionModule(HyperParam.AutoIntFeatureNum, self.tempEmbed)
