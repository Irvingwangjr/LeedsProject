...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerWithFieldFeaturePruningV1




### 只加入了feature embedding的pruning
class AutoFeaturePruning(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerWithFieldFeaturePruningV1(HyperParam.AutoIntFeatureNum,
