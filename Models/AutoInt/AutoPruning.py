...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerWithField, FieldAwarePruning


class AutoPruning(BaseModel):
    ...
    def loadFusionModule(self):
        return FieldAwarePruning(HyperParam.AutoIntFeatureNum, HyperParam.AutoPruningFeatureDim,
                                 HyperParam.AutoPruningFieldDim, HyperParam.AutoPruningBeta, HyperParam.AutoPruningZeta,
    ...
    def endPoint(self):
        ...
        loss = featureL0 + structureL0 + interactionL0
