...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerWithField


class AutoIntWithFieldLinear(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerWithField(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntWithFieldLayerDims,
    ...
    def loadMatchingModule(self):
        return AllConcatMlpWithLinear(HyperParam.AutoIntWithFieldMatchMlpDims, HyperParam.AutoIntFeatureNum,
                                            self.tempEmbed)
