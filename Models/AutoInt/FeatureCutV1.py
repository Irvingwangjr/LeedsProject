...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerBlank


class FeatureCutV1(BaseModel):
    ...
    def loadMatchingModule(self):
        return AllConcatMlpV2(HyperParam.AutoIntMatchMlpDims, defaultHooker)


def defaultHooker(userFeature, userTrans, itemFeature, itemTrans, contextFeature,
                  contextTrans, fusionFeature):
    return contextTrans[:,None,:]
