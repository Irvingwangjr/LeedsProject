...
from Models.Modules.MatchModule import DefaultMatchModule
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerRaw


class AutoIntRaw(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerRaw(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
                                        HyperParam.AutoIntHeadNumList, HyperParam.AutoIntMatchMlpDims)
