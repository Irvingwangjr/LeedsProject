...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerWithFieldFeaturePruningV3, \
    MultiLayerTransformerWithFieldFeaturePruningV4


# feature pruning + selfattention +叉乘+ pruning
class AutoFeaturePruningV4(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerWithFieldFeaturePruningV4(HyperParam.AutoIntFeatureNum,
                                                              HyperParam.AutoIntWithFieldLayerDims,
                                                              HyperParam.AutoIntWithFieldHeadNumList,
                                                              HyperParam.AutoIntFeatureNum,
                                                              HyperParam.AutoPruningFeatureDim,
                                                              HyperParam.AutoPruningFieldDim,
                                                              HyperParam.AutoPruningBeta,
