...
from Models.Modules.FusionModule import MultiLayerTransformerSTR


class STRV1(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerSTR(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
