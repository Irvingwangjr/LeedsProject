...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerWithFieldFeaturePruningV2



## embedding pruning 再加下来进field aware 的self-attention
class AutoFeaturePruningV2(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerWithFieldFeaturePruningV2(HyperParam.AutoIntFeatureNum,
