...
from Models.Modules.FusionModule import MultiLayerTransformer, MLTestTransformer
...
class RET(BaseModel):
    ...
    def loadFusionModule(self):
        return MLTestTransformer(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim, 5,depth=2)
    ...
    def loadMatchingModule(self):
        return AllConcatMlpV2([HyperParam.AutoIntMatchMlpDims[0], 1])
