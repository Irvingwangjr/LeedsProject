...
from Models.Modules.FusionModule import MultiLayerTransformer, MultiLayerTransformerX


class AutoIntV1(BaseModel):
    ...
    def loadFusionModule(self):
        return MultiLayerTransformerX(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntLayerDims,
