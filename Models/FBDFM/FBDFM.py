...
from Models.Modules.FusionModule import MultiLayerTransformer,FvFMFusionModule
from Models.Modules.MatchModule import FmMatchModule
import torch.nn as nn
import torch
import numpy as np


class FvFM(BaseModel):
    ...
    def loadFusionModule(self):
        return FvFMFusionModule(HyperParam.AutoIntFeatureNum, self.tempEmbed)
