...
from Models.Modules.FusionModule import XDeepFMFusion, XDeepFMFusionV2
import torch


class XDeepFMV2(BaseModel):
    ...
    def loadFusionModule(self):
        ...
        return XDeepFMFusionV2(HyperParam.AutoIntFeatureNum, HyperParam.AutoIntFeatureDim,
                               HyperParam.AutoIntMatchMlpDims)
